...
python code_train.py --is_finetune 0  --nz 4  --dataset img224 --dataset_path ${CODES_PATH} --code_level top --width 254 #--code_level bot #--zchannels 4 --kernel 1