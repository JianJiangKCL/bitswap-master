...
def train_args(parser: ArgumentParser):
	...
	parser.add_argument("--swa_epoch_start", default=0.8, type=float)
	parser.add_argument("--use_ema", choices=[0, 1], default=0, type=int, help="use Exponential Moving Average")
